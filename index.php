...
$url = new moodle_url('/report/test/index.php', $urlparams);
$title = get_string('pluginname', 'report_test');

$PAGE->set_context($context);
$PAGE->set_url($url);
$PAGE->set_title($title);
$PAGE->set_heading('Test report');
$PAGE->set_pagelayout('admin');

$output = $PAGE->get_renderer('report_test');
